...
public class ListInsertPerformance {	//练习题 3
...
//		插入元素
		...
		System.out.println("ArrayList Average delete time = "+(time1-time0)/(length/2)+"ns");
		System.out.println("ArrayList Average insert time = "+(time2-time1)/(length/4)+"ns");
	}
}